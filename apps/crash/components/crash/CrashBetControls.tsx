...
export default function CrashBetControls({
  ...
  const minBet = 10;
  const botUsername = process.env.NEXT_PUBLIC_BOT_USERNAME || "tg_emoji_casino_bot";
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          ...
          <button
            ...
            className="text-xs font-semibold text-blue-300 hover:text-blue-100 transition-colors underline-offset-4 underline"
          >
            Пополнить в боте
          </button>
        </div>
